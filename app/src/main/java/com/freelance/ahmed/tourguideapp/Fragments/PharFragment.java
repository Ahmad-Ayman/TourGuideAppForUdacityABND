...
public class PharFragment extends Fragment {
    private static final String TAG = PharFragment.class.getSimpleName();
    ...
    private static final String PHAR_FRAG="phar";
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle(getResources().getString(R.string.pharaonic));
    ...
    private void getPlacesDataFromRetrofit() {
        ...
        Call<Places> call = apiInterface.getPlaces(PHAR_FRAG);
