...
public class ChrisFragment extends Fragment {
    private static final String TAG = ChrisFragment.class.getSimpleName();
    ...
    private static final String CHRIS_FRAG="chris";

    public ChrisFragment() {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle(getResources().getString(R.string.christian));
    ...
    private void getPlacesDataFromRetrofit() {
        ...
        Call<Places> call = apiInterface.getPlaces(CHRIS_FRAG);
    ...
    private void showPlaceDataView() {
