...
public class IslamicFragment extends Fragment {
    private static final String TAG = IslamicFragment.class.getSimpleName();
    ...
    private static final String ISLAMIC_FRAG ="islam";
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle(getResources().getString(R.string.islamic));
    ...
    private void getPlacesDataFromRetrofit() {
        ...
        Call<Places> call = apiInterface.getPlaces(ISLAMIC_FRAG);
